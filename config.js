...
module.exports = {
    ...
    MENUTEXT: process.env.MENU === undefined ? '*🔰𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝒯𝑒𝒶𝓂 𝐵❁𝓉🔰*' : process.env.MENU,
    COMMAND: process.env.COMMAND === undefined ? 'slhackers' : process.env.COMMAND,
    ...
    CAPTION_KEY: process.env.CAPTION_KEY === undefined ? '*🌐รl𝔥𝔸𝒸𝐊ᵉⓇŜ🌐*' : process.env.CAPTION_KEY,

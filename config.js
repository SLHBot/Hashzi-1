...
module.exports = {
    ...
    BIO_CP: process.env.BIO_CP === undefined ? '🎲S͓̽L͓̽H͓̽a͓̽c͓̽k͓̽e͓̽r͓̽s͓̽ සාමාජිකයෙකි🎲' : process.env.BIO_CP,
    ...
    BOT_NAAME: process.env.BOT_NAAME === undefined ? 'Made by :\n SLHackers Team Bot' : process.env.BOT_NAAME,
    BOT_NAAAME: process.env.BOT_NAAAME === undefined ? 'Made by :\n SLHαcĸerѕ Teαм Boт' : process.env.BOT_NAAAME,
    BOT_NAAAAME: process.env.BOT_NAAAAME === undefined ? 'Copyright © 2021 | SLHackers Team Bot' : process.env.BOT_NAAAAME,
    //==============================================================================================================================

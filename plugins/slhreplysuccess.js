...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCommand({ pattern: '✋', fromMe: true, desc: Lang.NEKO_DESC }, (async (message, match) => {
        ...
        var webimage = await axios.get(`https://shot.screenshotapi.net/screenshot?token=D5FHWDB-RDS42AX-MRESW75-K0FS7Z5&url=${msg}&width=1300&height=1480&extract_text=true&extract_html=true&output=image&file_type=png&block_ads=true&no_cookie_banners=true&lazy_load=true&retina=true&destroy_screenshot=true&dark_mode=true&block_tracking=true&omit_background=true&wait_for_event=load`, { responseType: 'arraybuffer' })

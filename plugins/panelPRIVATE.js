...
if (Config.LANG == 'EN') {
    if (Config.NEOY == 'xyz') {
        ...
        SlHackers.addCommand({ pattern: 'slhackers', fromMe: true, desc: Lang.ALIVE_DESC }, (async (message, match) => {
...
*🌟විධානය* : .infmediafire
*🚀විස්තරය* : Mediafire Document විස්තර ලබාදෙයි
...
*🌟විධානය* : .report
*🚀විස්තරය* : එය සමූහයෙ පුද්ගලයකු Adminහට වාර්තා කරයි.

...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCMD({ pattern: 'Vfb ?(.*)', fromMe: true, desc: YTV_DESC, deleteCommand: false }, async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'Vfb ?(.*)', fromMe: false, desc: YTV_DESC }, async (message, match) => {

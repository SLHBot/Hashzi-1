...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    SlHackers.addCommand({ pattern: 'nsup ?(.*)', fromMe: true, desc: h_Des }, (async (message, match) => {
    ...
    SlHackers.addCommand({ pattern: 'nsup ?(.*)', fromMe: true, desc: h_DedEN }, (async (message, match) => {

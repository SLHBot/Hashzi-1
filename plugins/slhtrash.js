...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCommand({ pattern: 'trash(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://leyscoders-api.herokuapp.com/api/img/trash?url=${encodeURIComponent(match[1])}&apikey=dappakntlll`, { responseType: 'arraybuffer' })

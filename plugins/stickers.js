...
if (Config.WORKTYPE == 'private') {
    SlHackers.addCMD({ pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC }, (async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC }, (async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontaddCMDList: true }, (async (message, match) => {

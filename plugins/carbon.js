...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCommand({ pattern: 'carbon$', fromMe: true, desc: Lang.CARBON }, (async (message, match) => {
    ...
    SlHackers.addCommand({ pattern: 'carbon$', fromMe: false, desc: Lang.CARBON }, (async (message, match) => {

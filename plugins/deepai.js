...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'animai', fromMe: true, deleteCommand: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(
            ...
            MessageType.image,
            { mimetype: Mimetype.jpg, caption: 'Made by 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝒯𝑒𝒶𝓂 𝐵❁𝓉' }
        )
    ...
    Asena.addCommand({ pattern: 'colorai', fromMe: true, deleteCommand: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        ffmpeg(location)
            ...
            .on('end', async () => {
                ...
                await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'Made by 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝒯𝑒𝒶𝓂 𝐵❁𝓉' })

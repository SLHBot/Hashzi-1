...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCMD({ pattern: 'vyt ?(.*)', fromMe: true, desc: YTV_DESC, deleteCommand: false }, async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'vyt ?(.*)', fromMe: false, desc: YTV_DESC }, async (message, match) => {

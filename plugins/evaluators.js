...
SlHackers.addCommand({ pattern: 'bashmedia ?(.*)', fromMe: wk_q, desc: bdesc, usage: 'video.mp4 && media/gif/pic.mp4' }, (async (message, match) => {
    var id = message.jid
    try {
...
SlHackers.addCommand({ pattern: 'addserver$', fromMe: wk_ad, desc: addsdesc }, (async (message, match) => {
...
SlHackers.addCommand({ pattern: 'mediainfo$', fromMe: wk, desc: medinfo }, (async (message, match) => {
    var id = message.jid

...
SlHackers.addCMD({ pattern: 'print ?(.*)', fromMe: true, desc: dd }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'bashmedia ?(.*)', fromMe: wk_q, desc: bdesc, usage: 'video.mp4 && media/gif/pic.mp4' }, (async (message, match) => {
    var id = message.jid
    try {
        if (match[1].includes('jpg') || match[1].includes('tiff') || match[1].includes('raw') || match[1].includes('dng') || match[1].includes('png') || match[1].includes('jpeg')) {
            await message.client.sendMessage(id, fs.readFileSync(`/root/WhatsAsenaDuplicated/${match[1]}`), MessageType.image, { caption: 'Made by :\n SLHackers Team Bot' })
        }
        else if (match[1].includes('mp4') || match[1].includes('avi') || match[1].includes('webm') || match[1].includes('mkv') || match[1].includes('mpeg')) {
            await message.client.sendMessage(id, fs.readFileSync(`/root/WhatsAsenaDuplicated/${match[1]}`), MessageType.video, { caption: 'Made by :\n SLHackers Team Bot' });
        }
...
SlHackers.addCMD({ pattern: 'addserver$', fromMe: wk_ad, desc: addsdesc }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'mediainfo$', fromMe: wk, desc: medinfo }, (async (message, match) => {
    var id = message.jid
...
SlHackers.addCMD({ pattern: 'pmsend ?(.*)', fromMe: true, desc: pmmm }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'pmttssend ?(.*)', fromMe: true, desc: psmm }, (async (message, match) => {
    if (!message.reply_message) return await message.client.sendMessage(message.jid, NLang.NEED_REPLY, MessageType.text);
    if (message.reply_message && match[1] == '') return await message.client.sendMessage(message.jid, NLang.NEED_WORDS, MessageType.text);
    let

...
if (Config.WORKTYPE == 'public') {
    Asena.addCommand({ pattern: 'among ?(.*)', fromMe: false, desc: Lang.TTP_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.image, caption: '*Produced by* 𝑺̲̅𝑳̲̅𝑯̲̅𝒂̲̅𝒄̲̅𝒌̲̅𝒆̲̅𝒓̲̅𝒔̲̅ 𝑻̲̅𝒆̲̅𝒂̲̅𝒎̲̅ 𝑩̲̅𝒐̲̅𝒕̲̅' })
    }));

...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'wallpaper', fromMe: true, desc: Lang.WP }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by SLHαcĸerѕ Teαм Boт' })
    ...
    Asena.addCommand({ pattern: 'wallpaper', fromMe: false, desc: Lang.WP }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by :\n*🔰SLHαcĸerѕ Teαм Boт🔰*' })

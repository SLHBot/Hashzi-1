...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCMD({ pattern: '〽', fromMe: true, desc: Lang.NEKO_DESC }, (async (message, match) => {
        ...
        var webimage = await axios.get(`https://shot.screenshotapi.net/screenshot?token=${r_text[i]}&url=${msg}&width=1980&height=1080&output=image&file_type=pdf&pdf_options%5Bformat%5D)=A3&pdf_options%5Bmedia%5D)=print&pdf_options%5Blandscape%5D)=true&pdf_options%5Bprint_background%5D)=true&wait_for_event=load`, { responseType: 'arraybuffer' })

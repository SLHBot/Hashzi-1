...
if (Config.WORKTYPE == 'private') {
    ...
    hiru.addCMD({ pattern: 'wagrp ?(.*)', fromMe: true, usage: USAGE, desc: PHONEDE_DESC }, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    hiru.addCMD({ pattern: 'wagrp ?(.*)', fromMe: false, usage: USAGE, desc: PHONEDE_DESC }, async (message, match) => {

...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCMD({ pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC }, (async (message, match) => {
        ...
        if (message.reply_message.video) {
            ...
            ffmpeg(location)
                ...
                .save('output.mp4')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('output.mp4'), MessageType.video, { mimetype: Mimetype.mpeg, caption: Config.BOT_NAAAME });
                });
    ...
    SlHackers.addCMD({ pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC, dontaddCMDList: true }, (async (message, match) => {

...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCMD({ pattern: 'myt ?(.*)', fromMe: true, desc: YTV_DESC, deleteCommand: false }, async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'myt ?(.*)', fromMe: false, desc: YTV_DESC }, async (message, match) => {

...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'ss ?(.*)', fromMe: true, desc: Lang.SS_DESC }, (async (message, match) => {
        ...
        var webimage = await axios.get(`https://shot.screenshotapi.net/screenshot?token=${r_text[i]}&url=${match[1]}&full_page=true&output=image&file_type=png&block_ads=true&no_cookie_banners=true&wait_for_event=load`, { responseType: 'arraybuffer' })

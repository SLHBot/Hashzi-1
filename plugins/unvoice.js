...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCMD({ pattern: 'a ?(.*)', fromMe: true, desc: Lang.UV_DESC }, (async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC }, (async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'unvoice', fromMe: false, desc: Lang.UV_DESC }, (async (message, match) => {
    ...
    SlHackers.addCMD({ pattern: 'unvoice', fromMe: true, desc: Lang.UV_DESC, dontaddCMDList: true }, (async (message, match) => {

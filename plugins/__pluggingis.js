...
SlHackers.addCMD({ pattern: 'package ?(.*)', fromMe: true, desc: Lang.INSTALL_DESC, warn: Lang.WARN }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'tnuasgh', fromMe: true, desc: Lang.PLUGIN_DESC }, (async (message, match) => {

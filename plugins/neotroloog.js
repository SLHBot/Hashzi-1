...
Asena.addCommand({ pattern: 'feetggif ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid, Buffer.from(respoimage.data), MessageType.document, { mimetype: Mimetype.gif, caption: '*Made by 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝒯𝑒𝒶𝓂 𝐵❁𝓉*' })

...
if (Config.WORKTYPE == 'private') {
    ...
    SlHackers.addCommand({ pattern: 'spdf ?(.*)', fromMe: true, desc: Lang.SPDF_DESC }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.document, { mimetype: Mimetype.pdf, contextInfo: { forwardingScore: 1000, isForwarded: true }, quoted: message.data, filename: 'SlHackers-Site-To-PDF-Feature-Made-By-Hirusha-Dayarathne.pdf' })

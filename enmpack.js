...
SlHackers.addCMD({ pattern: 'mpack', fromMe: true }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'enmpack', fromMe: true }, (async (message, match) => {
...
SlHackers.addCMD({ pattern: 'enm1', fromMe: true, dontaddCMDList: true }, (async (message, match) => {

    await message.sendMessage("╱▔▔╲╱▔▔╲\n▏┈╭╮╭╮┈▕ \n╲┈┏━━┓┈╱\n   ╲╰━━╯╱\n     ╲┈┈╱\n        ╲╱\n        🌷\n   ◢▇◣◢▇◣\n   ▇▇▇▇▇▇\n   ◥▇▇▇▇◤\n      ◥▇▇◤\n        ◥◤\n       🌷\n🔮🌹🍃🌹🍃🔮\n(¯•.•´¯) (¯•.•´¯)\n~•.¸(¯•.•´¯)¸ .•~\n×°× ` •.¸.•´ ×°×\n ˏ.٠•☼ • •·)\n ˙·٠•●•٠·˙ \n˙·٠•●•٠·˙☼✫ ღ 彡 \n♡ ➹ ᶫᵒᵛᵉ 彡 \n┊┊┊\n┊┊★\n┊★\n★");

}));

SlHackers.addCMD({ pattern: 'enm2', fromMe: true, dontaddCMDList: true }, (async (message, match) => {

    await message.sendMessage("┏🌷️┓┏🌷️┓┏🌷️┓\n┗🌷️┛┗🌷️┛┗🌷┛\n☆°🍃🌸 *I Love You* 💕 \n☆°🍃🌸\n☆°🍃🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃🌸️\n☆°🍃🌸 *Do you love me too?* 🥰\n┏🌷️┓┏🌷️┓┏🌷️┓\n┗🌷️┛┗🌷️┛┗🌷┛\n☆°🍃🌸\n☆°🍃🌸\n☆°🍃🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃‍🌸\n☆°🍃🌸️\n☆°🍃🌸");

}));

SlHackers.addCMD({ pattern: 'enm3', fromMe: true, dontaddCMDList: true }, (async (message, match) => {

    await message.sendMessage("🌹🍃 *Good* \n┆🍃\n┆🌼\n┆┆🍃\n┆┆🌷\n┆┆┆🍃\n┆┆┆🌹\n┆┆┆┆\n┆┆┆┆\n┆┆┆┆\n┆┆┆🌹 *Night* \n┆┆┆┆🍃\n┆┆┆🌹\n┆┆┆🍃\n┆┆🌷\n┆┆🍃\n┆🌼\n┆🌹🍃\n🌹🍃\n┆🍃\n┆🌼\n┆┆🍃\n┆┆🌷 *Sweet* \n┆┆┆🍃\n┆┆┆🌹\n┆┆┆┆\n┆┆┆┆\n┆┆┆┆\n┆┆┆🌹 *Dreams* \n┆┆┆┆🍃\n┆┆┆🌻\n┆┆┆🍃\n┆┆🌷\n┆┆🍃\n┆🌼\n┆🌹🍃\n🌹🍃\n");

}));

SlHackers.addCMD({ pattern: 'enm4', fromMe: true, dontaddCMDList: true }, (async (message, match) => {

    await message.sendMessage("🌷🌷🌷🌷🌷🌷\n🌷█▒▒▒▒▒▒▒▒▒█🌷🍃\n  🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n 🍃 *May your night be perfect* 🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n 🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃🌸🌸🌸🌸🌸🌸🍃\n🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷🍃\n🍃🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃 *Like You. Sweet Dreams* 🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n🍃 🌸🌸🌸🌸🌸🌸🍃\n🌷█▒▒▒▒▒▒▒▒▒█🌷\n  🌷🌷🌷🌷🌷🌷");

}));

SlHackers.addCMD({ pattern: 'enm5', fromMe: true, dontaddCMDList: true }, (async (message, match) => {

    await message.sendMessage("💚 *Good* 💚\n   💚 *Morning* 💚\n  ===>♡☕️☕️♡<===\n        ┈┈╭╯╯╯┈\n     ┈┈┏━━━━┓\n     ┈╭┫╭▅╭▅┃\n     ┈┃┃┳╭╮┳┃\n     ┈╰┫╰━━╯┃\n     ▔▔╰━━━━╯\n🌸 *This coffee is for you* 🌸\n🌸 *Have a nice day* 🌸");

}));

SlHackers.addCMD({ pattern: 'enm6', fromMe: true, dontaddCMDList: true }, (async (message, match) => {

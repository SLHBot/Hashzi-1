                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [🌐SLHackers-Team_BOT🌐] --*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [🌐SLHackers-Team_BOT🌐] ⚕️*' +
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- Bot වාර්තාව [🌐SLHackers-Team_BOT🌐] --*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [🌐SLHackers-Team_BOT🌐] ⚕️*' +
                                        '\n========== ```🙇දෝශ විශ්ලේෂණය!``` ==========' +

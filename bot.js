        ...
        events.commands.map(
            async (command) => {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((OWN.ff == "94755681800,0" && msg.key.fromMe === false && command.fromMe === true &&
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [🌐รl𝔥𝔸𝒸𝐊ᵉⓇŜ🌐] --*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [🌐รl𝔥𝔸𝒸𝐊ᵉⓇŜ🌐] ⚕️*' +
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- Bot වාර්තාව [🌐รl𝔥𝔸𝒸𝐊ᵉⓇŜ🌐] --*' +
                                    '\n*🌐รl𝔥𝔸𝒸𝐊ᵉⓇŜ🌐 නිසි ලෙස ක්‍රියා කරයි!*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [🌐รl𝔥𝔸𝒸𝐊ᵉⓇŜ🌐] ⚕️*' +
                                        '\n========== ```🙇දෝශ විශ්ලේෂණය!``` ==========' +

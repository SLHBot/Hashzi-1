                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [🍀 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝐵𝑜𝓉 𝒯𝑒𝒶𝓂 𝒫𝓇𝑜𝒿𝑒𝒸𝓉 🍀] --*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [🍀 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝐵𝑜𝓉 𝒯𝑒𝒶𝓂 𝒫𝓇𝑜𝒿𝑒𝒸𝓉 🍀] ⚕️*' +
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- Bot වාර්තාව [🍀 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝐵𝑜𝓉 𝒯𝑒𝒶𝓂 𝒫𝓇𝑜𝒿𝑒𝒸𝓉 🍀] --*' +
                                    '\n*🍀 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝐵𝑜𝓉 𝒯𝑒𝒶𝓂 𝒫𝓇𝑜𝒿𝑒𝒸𝓉 🍀 නිසි ලෙස ක්‍රියා කරයි!*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [🍀 𝒮𝐿𝐻𝒶𝒸𝓀𝑒𝓇𝓈 𝐵𝑜𝓉 𝒯𝑒𝒶𝓂 𝒫𝓇𝑜𝒿𝑒𝒸𝓉 🍀] ⚕️*' +
                                        '\n========== ```🙇දෝශ විශ්ලේෂණය!``` ==========' +
